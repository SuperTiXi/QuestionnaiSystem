...
public class GroupController {
     ...
     * @return 添加状态
     */
    @RequestMapping(value = "/addAnswerer",method = RequestMethod.POST,headers = "Accept=application/json")
     ...
     * @return 删除状态
     */
    @RequestMapping(value = "/removeAnswerer",method = RequestMethod.DELETE,headers = "Accept=application/json")
